...
const Home = () => {
  return (
    ...
    <TooltipProvider>
          ...
          <div className="contain grid grid-cols-1 md:grid-cols-2 gap-4 py-20 md:py-40 ">
            <div className="order-2 md:order-1">
              <h1>
                <span className="text-2xl text-purple-900 font-serif">
                  Hello👋🏻, It's Me
                </span>
              </h1>
              ...
              <p className="text-xl text-purple-900 font-serif">
                ...
                development. My passion lies in designing, creating, and
                maintaining software for applications and systems. I focus on
                building software solutions that meet user needs effectively.
              </p>
              <br />
